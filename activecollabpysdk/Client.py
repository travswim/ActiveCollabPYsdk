...
class Client(ClientInterface):
    ...
    def __init__(self, token: Token, api_version: int = 1) -> None:
        ...
        if api_version < 0:
            raise InvalidArgumentError(
                f'{api_version} is not a valid API version'
            )
    ...
    def _prepare_url(self, url: str) -> str:
        ...
        Formats a url and checks if it is valid. Used by post, get, put, and
        delete requests to ActiveCollab
    ...
    #     :param dict[str, Any] params: Paramerters to pass as data or JSON to
    #                                       ActiveCollab
    ...
    ) -> dict[str, BufferedReader]:
        """Converts a list of file paths to file objects.

        Converts a list of file paths to file objects. Used by post() method
        to post files to ActiveCollab
    ...
    def post(
        ...
        """HTTP Post request to ActiveCollab (Create New)
            ...
            Makes a post request to ActiveCollab using the provided URL,
            parameters/data, and attachments (optional)
    ...
    def delete(self, url: str) -> None:
        """HTTP Delete request from ActiveCollab
            ...
            Makes a delete request to ActiveCollab using the provided URL and
            parameters
